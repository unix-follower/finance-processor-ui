...
export default function PredictionTable({ predictions }: Props) {
  ...
  const columns: GridColDef[] = [
    { field: "ticker", headerName: t("predictionTable.header.ticker"), width: 100 },
    { field: "openRangeAt", headerName: t("predictionTable.header.openRangeAt"), width: 150 },
    { field: "closedRangeAt", headerName: t("predictionTable.header.closedRangeAt"), width: 150 },
    { field: "predictionAt", headerName: t("predictionTable.header.predictionAt"), width: 225 },
    { field: "pricePrediction", headerName: t("predictionTable.header.pricePrediction"), width: 200 },
  ]
